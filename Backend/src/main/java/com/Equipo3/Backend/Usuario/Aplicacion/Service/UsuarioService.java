...
public class UsuarioService {
    ...
    public void Modificar_Usuario(UsuarioDTO usuariodto) throws Exception {
        ...
        Usuario user = new Usuario(nbd.getId(), nbd.getNombre(), nbd.getPassword(), nbd.getEmail(), nbd.getFecha_nacimiento(), nbd.getTelefono(), nbd.getRol(), nbd.getIdamigos(), nbd.getIdeventos());
